import { getUser, verifyPassword, createUserSession, validEmail, normEmail, userPublic, loginAllowed, noteLoginFail, clearLoginFail, isOwnerEmail, grantOwnerAccess } from "../../_auth.js";
...
export async function onRequestPost(context){
  ...
  if (isOwnerEmail(env, email) && (user.tier !== "premium" || user.access !== "all")) await grantOwnerAccess(kv, user);
